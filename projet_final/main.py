...
sys.path.append('../projet_final/scripte_python') 
...
edf = pd.read_csv("../projet_final/CSV/productions-consolidees-par-pays-du-groupe-edf.csv",delimiter=';')
iso=pd.read_csv("../projet_final/CSV/all.csv")
